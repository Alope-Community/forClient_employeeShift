...
<div class="main p-3 ms-3 mt-3">
    ...
    <form action="{{ route('leave-application.update', $report->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('leave-application.index') }}" class="btn btn-secondary">Batal</a>
    </form>
</div>
@endsection
