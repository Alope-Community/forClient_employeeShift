    ...
    <div class="card">
        <div class="card-body">
            ...
            <h6 class="card-subtitle mb-3 text-muted">
                Diajukan oleh: {{ $shiftReport->employee->name }} pada {{ \Carbon\Carbon::parse($shiftReport->time)->translatedFormat('d M Y, H:i') }}
            </h6>
            ...
            <dl class="row">
                ...
                @if ($shiftReport->image)
                    ...
                    <dd class="col-sm-9">
                        <img src="{{ asset('storage/' . $shiftReport->image) }}" alt="Bukti" class="img-fluid rounded" style="max-height: 300px;">
                    </dd>
                @endif
            ...
            <a href="{{ route('leave-application.index') }}" class="btn btn-secondary mt-3">Kembali</a>
        </div>
    </div>
</div>
@endsection
