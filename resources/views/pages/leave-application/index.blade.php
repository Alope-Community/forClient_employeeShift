                ...
                <tbody>
                    @foreach ($reports as $index => $report)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('leave-application.show', $report->id) }}"
                                    class="btn btn-sm btn-info">Detail</a>
                                <a href="{{ route('leave-application.edit', $report->id) }}"
                                    class="btn btn-sm btn-secondary">Edit</a>
                                <form action="{{ route('leave-application.destroy', $report->id) }}" method="POST"
